...
//      logger.info("XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX");
    ...
    */
	 ...
	 * 
	 * public static void info(boolean flag) { logger.info(flag); }
	 * 
	 * public static void info(int length) { logger.info(length); }
	 * 
	 * public static void warn(String message) { logger.warn(message); }
	 * 
	 * public static void error(final String message) { logger.error(message); }
	 * 
	 * public static void error(Throwable t) { logger.error(t); }
	 * 
